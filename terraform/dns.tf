...
resource "google_dns_record_set" "knative_site_workshop" {
  name         = "*.workshop.${data.google_dns_managed_zone.knative_site.dns_name}"
...
resource "google_dns_record_set" "knative_club_workshop" {
  name         = "*.workshop.${data.google_dns_managed_zone.knative_club.dns_name}"
